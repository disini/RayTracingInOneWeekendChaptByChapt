//
// Created by liusheng on 23-4-25.
//
...
//virtual  bool bounding_box(double )
    ...
    bool bvh_node::hit(const ray &r, double t_min, double t_max, hit_record &rec) const {
        ...
        bool hit_right = right->hit(r, t_min, hit_left ? rec.t : t_max, rec);// 此处的t不是时间，而是代表距离的系数t.
